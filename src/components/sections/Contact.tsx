    ...
    if (sectionRef.current) {
      ...
      if (isMobile) {
        ...
        tl.from(sectionRef.current, { opacity: 0, y: 100 })
          .from('.contact-header', { opacity: 0, y: 50 }, '-=0.4')
          .fromTo('.contact-info-item', { opacity: 0, y: 30 }, { opacity: 1, y: 0, duration: 0.6, stagger: 0.15 }, '-=0.3')
          .fromTo('.social-link-item', { opacity: 0, scale: 0.8 }, { opacity: 1, scale: 1, duration: 0.5, stagger: 0.1 }, '-=0.4')
          .fromTo('.contact-form', { opacity: 0, y: 50 }, { opacity: 1, y: 0, duration: 0.8 }, '-=0.3');
      }
    }
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-8 mb-12 max-w-5xl mx-auto">
          ...
          <div className="contact-info-grid space-y-4">
            ...
            <div className="contact-info-item flex items-center justify-between p-4 bg-white/10 rounded-xl border border-white/20 hover:border-white/40 transition-all group shadow-lg">
          ...
          <div>
            ...
            <div className="social-links-grid grid grid-cols-2 gap-4 mb-8">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="social-link-item flex items-center gap-3 p-4 bg-white/10 rounded-xl border border-white/20 hover:border-white/40 hover:bg-white/20 transition-all shadow-lg"
              >
