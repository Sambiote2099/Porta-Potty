          ...
          <div className="max-w-2xl space-y-6">
            ...
            <div className="cta-buttons flex flex-wrap gap-4">
              <button
                ...
                className="inline-flex items-center gap-2 px-6 py-3 bg-white text-slate-900 rounded-lg transition-all transform hover:scale-105 font-semibold shadow-lg hover:shadow-xl cursor-pointer"
              >
                View My Work
